...
description: Smarty Code'ı hızlıca başlatın ve iş için doğru uygulamayı seçin.
---
...
2. Smarty Code CLI'yı yükleyin. Tek satırlık komut için [Install](/install/) sayfasına bakın.
...
Tarayıcınızda Smarty Code oturum listesini görmelisiniz. Yüklendiyse çalışıyordur.
