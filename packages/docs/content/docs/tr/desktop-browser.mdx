...
**Clear cookies** ve **Clear cached data** yalnızca bu panele uygulanır. Smarty Code oturumunuza ve diğer pencerelere dokunulmaz.
...
Tarayıcı eylemleri **Smarty Code Web tool**'dur. Bunu **Settings → General → Smarty Code Tools** altında ayrı ayrı açıp kapatabilirsiniz.
