---
title: Ses Modu
description: Smarty Code ile konuşun ve yanıtları sesli dinleyin.
---

# Ses Modu

Ses modu, mesajları dikte etmenizi ve yanıtları size geri okutmanızı sağlar. Bunu **Settings → Smarty Code → Voice** bölümünden açın.
