---
title: 移动应用与 PWA
description: 在 iOS 或 Android 上安装 smarty-code 应用，并把它连接到你的服务器。
---

# 移动应用与 PWA

smarty-code 提供 iPhone 和 Android 原生应用，让你可以在手机上查看会话、回复代理并管理工作 — 在家通过 Wi-Fi，外出时通过 [Private Relay](/zh-cn/private-relay/)。
...
1. 在运行 smarty-code 的电脑上，打开 **Settings → Remote Instances → 连接到此服务器**，然后按 **添加设备**。
...
在 **Settings → smarty-code** 下，有几个选项可以调整移动端和已安装应用的体验 — 应用的安装名称、屏幕方向，以及屏幕键盘的行为方式。
