...
**Clear cookies** and **Clear cached data** apply to this panel alone. Your Smarty Code session and any other window are untouched.
...
The browser actions are the **Smarty Code Web tool**, which can be turned on and off on its own in **Settings → General → Smarty Code Tools**.
