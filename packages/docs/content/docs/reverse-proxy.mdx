---
title: Reverse Proxy
description: Configure smarty-code correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run smarty-code behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
