---
title: Теми
description: Налаштуйте Smarty Code за допомогою вбудованих і власних тем.
---

# Теми

Smarty Code підтримує вбудовані теми та власні JSON-файли тем.
...
3. Відкрийте Smarty Code, потім перейдіть до **Settings -> Theme -> Reload themes**.
