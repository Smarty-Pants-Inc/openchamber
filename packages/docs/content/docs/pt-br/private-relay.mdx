...
**Settings → Remote Instances → Smarty Code Relay** mostra o estado ao vivo (Conectado, Reconectando, …) e quantos dispositivos estão conectados por ele neste momento. Você também pode pressionar **Desativar** ali para cortar o acesso pelo relay imediatamente; os dispositivos na sua rede local não são afetados.
...
- Use um [túnel](/pt-br/tunnels/) quando você precisar de uma **URL pública** comum — por exemplo, para abrir o Smarty Code em um navegador qualquer numa máquina que você não pode parear, ou para compartilhar o acesso protegido por uma [senha de UI](/pt-br/security/).
