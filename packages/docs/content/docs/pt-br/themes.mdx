---
title: Temas
description: Personalize o Smarty Code com temas integrados e definidos pelo usuário.
---

# Temas

O Smarty Code oferece suporte a temas integrados e arquivos JSON de tema personalizados.
...
3. Abra o Smarty Code e vá em **Settings -> Theme -> Reload themes**.
