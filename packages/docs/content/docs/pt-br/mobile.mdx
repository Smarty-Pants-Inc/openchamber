...
description: Instale o app do Smarty Code no iOS ou Android e conecte-o ao seu servidor.
---

# Apps Móveis e PWA

O Smarty Code tem apps nativos para iPhone e Android, então você pode acompanhar sessões, responder aos agentes e gerenciar o trabalho pelo celular — em casa pelo Wi-Fi ou de qualquer lugar pelo [Private Relay](/pt-br/private-relay/).
...
1. No computador que executa o Smarty Code, abra **Settings → Remote Instances → Conectar a este servidor** e pressione **Adicionar um dispositivo**.
...
Em **Settings → Smarty Code**, algumas opções ajustam a experiência móvel e instalada — o nome instalado do app, a orientação da tela e como o teclado na tela se comporta.
