---
title: Reverse Proxy
description: Konfigurieren Sie Smarty Code korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn Smarty Code hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass Smarty Code direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn Smarty Code Antworten bereits komprimiert.
...
- Smarty Code direkt im LAN erreichbar
...
- Smarty Code komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von Smarty Code von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
