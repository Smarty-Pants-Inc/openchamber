---
title: Schnellstart
description: Starte smarty-code schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das smarty-code-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
...
Du solltest die smarty-code-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
