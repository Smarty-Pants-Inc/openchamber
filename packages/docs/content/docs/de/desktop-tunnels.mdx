...
Die Desktop-App kann unter **Settings → smarty-code → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du smarty-code nicht per CLI starten.

## Anbieter installieren

smarty-code startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → smarty-code → Tunnel**.
