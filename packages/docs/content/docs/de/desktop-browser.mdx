...
**Cookies löschen** und **Zwischengespeicherte Daten löschen** gelten allein für dieses Panel. Deine Smarty Code-Sitzung und andere Fenster bleiben unberührt.
...
Die Browser-Aktionen sind das **Smarty Code-Web-Werkzeug**, das sich unter **Einstellungen → Allgemein → Smarty Code-Werkzeuge** einzeln ein- und ausschalten lässt.
