...
description: Änderungen vormerken, committen und Branches verwalten, ohne smarty-code zu verlassen.
---

# Git- & GitHub-Workflows

smarty-code hat eine integrierte Git-Ansicht, damit du Änderungen prüfen, committen und Branches verwalten kannst, ohne in ein Terminal zu wechseln. Öffne sie über den **Git**-Tab in der rechten Seitenleiste.
...
Schreibe dann eine Commit-Nachricht und committe. Du kannst smarty-code eine **Commit-Nachricht generieren** lassen, basierend auf deinen gestagten Änderungen — dabei wird das Modell der aktuellen Sitzung verwendet, also brauchst du eine geöffnete Sitzung.
...
Wenn ein Merge, Rebase oder Integrate auf einen Konflikt stößt, zeigt smarty-code, was festhängt, und lässt dich es lösen — einschließlich der Übergabe an den Agenten.
