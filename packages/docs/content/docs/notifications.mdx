...
Notifications tell you when something needs your attention so you don't have to watch the screen — a session finished, hit an error, asked a question, or needs permission to do something. Set them up at **Settings → Smarty Code → Notifications**.

## Turn them on

1. Open **Settings → Smarty Code → Notifications**.
