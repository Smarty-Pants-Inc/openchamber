---
title: Themes
description: Customize Smarty Code with built-in and user-defined themes.
---

# Themes

Smarty Code supports built-in themes and custom theme JSON files.
...
3. Open Smarty Code, then go to **Settings -> Theme -> Reload themes**.
