---
title: Proxy inverso
description: Configura Smarty Code correctamente detrás de Nginx, Nginx Proxy Manager u otro proxy inverso.
---

# Proxy inverso

Usa esta página si ejecutas Smarty Code detrás de Nginx, Nginx Proxy Manager, Caddy, Cloudflare u otro proxy inverso.

## Antes de ponerle un proxy

1. Confirma primero que Smarty Code funciona directamente.
...
- Desactiva gzip en el proxy si Smarty Code ya comprime las respuestas.
...
- Smarty Code accesible directamente en la LAN
...
- Smarty Code comprime las respuestas HTTP con gzip (umbral de 1 KB).
...
Las rutas de streaming SSE están excluidas de la compresión por Smarty Code, pero la CDN aún puede almacenarlas en búfer. Consulta la documentación de tu CDN para saber cómo desactivar el búfer en las rutas SSE.
