...
Una integración es un pequeño plugin que añade un proveedor a Smarty Code usando una suscripción que ya tienes. Las gestionas en **Settings → Integrations**.
...
Cursor hace disponibles en Smarty Code los modelos incluidos en tu plan de Cursor.
