...
**Borrar cookies** y **Borrar datos en caché** afectan únicamente a este panel. Tu sesión de Smarty Code y cualquier otra ventana quedan intactas.
...
Las acciones del navegador son la **herramienta Smarty Code Web**, que se activa y desactiva por separado en **Ajustes → General → Herramientas de Smarty Code**.
