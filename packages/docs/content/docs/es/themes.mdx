---
title: Temas
description: Personaliza smarty-code con temas integrados y definidos por el usuario.
---

# Temas

smarty-code admite temas integrados y archivos JSON de tema personalizados.
...
3. Abre smarty-code y ve a **Settings -> Theme -> Reload themes**.
