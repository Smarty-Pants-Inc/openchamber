---
title: Quickstart
description: Start smarty-code quickly and pick the right app for the task.
---
...
2. Install the smarty-code CLI (see [Install](/install/) for the one-line command).
...
You should see the smarty-code session list in your browser. If it loads, you're up and running.
