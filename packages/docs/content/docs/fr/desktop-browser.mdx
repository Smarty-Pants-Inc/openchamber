...
**Effacer les cookies** et **Effacer les données en cache** ne concernent que ce panneau. Votre session Smarty Code et les autres fenêtres n'y touchent pas.
...
Les actions du navigateur constituent l'**outil Smarty Code Web**, qui s'active et se désactive séparément dans **Réglages → Général → Outils Smarty Code**.
