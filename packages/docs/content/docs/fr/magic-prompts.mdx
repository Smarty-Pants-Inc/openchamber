---
title: Magic Prompts
description: Personnalisez les prompts intégrés derrière les flux automatisés d’smarty-code.
---
...
Certains prompts ont une partie visible (le message que vous verriez) et une partie instructions (des consignes cachées pour l’agent). Les prompts peuvent contenir des `{{placeholders}}` qu’smarty-code remplit, comme le diff ou le titre de l’issue — gardez-les en place.
