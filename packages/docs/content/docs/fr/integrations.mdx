...
Une intégration est un petit plugin qui ajoute un fournisseur à Smarty Code à partir d'un abonnement que tu possèdes déjà. Tu les gères dans **Settings → Integrations**.
...
Cursor rend disponibles dans Smarty Code les modèles inclus dans ton plan Cursor.
