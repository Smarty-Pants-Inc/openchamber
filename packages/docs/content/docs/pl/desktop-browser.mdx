...
**Wyczyść ciasteczka** i **Wyczyść dane w pamięci podręcznej** dotyczą wyłącznie tego panelu. Twoja sesja smarty-code i pozostałe okna zostają nietknięte.
...
Działania w przeglądarce to **narzędzie smarty-code Web**, które włącza się i wyłącza osobno w **Ustawienia → Ogólne → Narzędzia smarty-code**.
