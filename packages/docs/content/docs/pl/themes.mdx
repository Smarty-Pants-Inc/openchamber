---
title: Motywy
description: Dostosuj smarty-code za pomocą wbudowanych i własnych motywów.
---

# Motywy

smarty-code obsługuje wbudowane motywy oraz własne pliki JSON z motywami.
...
3. Otwórz smarty-code, a następnie przejdź do **Settings -> Theme -> Reload themes**.
