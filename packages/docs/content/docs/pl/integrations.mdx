...
Integracja to mała wtyczka, która dodaje dostawcę do Smarty Code na podstawie subskrypcji, którą już masz. Zarządzasz nimi w **Settings → Integrations**.
...
Cursor udostępnia w Smarty Code modele zawarte w Twoim planie Cursor.
