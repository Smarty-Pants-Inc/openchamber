...
Zaplanowane zadanie uruchamia za Ciebie prompt według harmonogramu — na przykład codzienne „podsumuj wczorajsze zmiany” albo cotygodniowe porządki. Gdy się uruchamia, smarty-code rozpoczyna nową sesję i sam wysyła prompt. Otwórz harmonogram z przycisku u góry paska bocznego sesji.
...
Zadania uruchamiają się tylko wtedy, gdy serwer smarty-code działa. Jeśli go zamkniesz, zaplanowane uruchomienia są wstrzymane, dopóki nie wróci.
