---
title: テーマ
description: 組み込みテーマとユーザー定義テーマで smarty-code をカスタマイズします。
---

# テーマ

smarty-code は組み込みテーマとカスタムテーマ JSON ファイルに対応しています。
...
3. smarty-code を開き、**Settings -> Theme -> Reload themes** に移動します。
