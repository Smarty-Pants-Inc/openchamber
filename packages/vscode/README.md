...
Smarty Code is an AI coding workspace right inside your editor. No tab-switching, no context loss.
...
| `Smarty Code: Restart API Connection` | Restart the engine API process |
