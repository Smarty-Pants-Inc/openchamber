// PCM16 24 kHz capture and playback worklet for session voice calls.
// Adapted from GipPity Control (@howaboua/pi-gippity-control, src/voice/lan/audio-worklet.ts),
// MIT License, Copyright (c) 2026 Igor Warzocha. Unchanged except the processor name.
export const PI_VOICE_WORKLET_NAME = 'pi-session-voice';

export const PI_VOICE_WORKLET = String.raw`
...
registerProcessor('pi-session-voice', PiLanVoiceProcessor);
`;
