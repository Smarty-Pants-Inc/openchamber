...
export const settingsDict = {
  ...
  'settings.view.home.cards.plugins.description': '엔진 플러그인 관리',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.skills.sidebar.badge.opencode': '엔진',
  ...
  'settings.skills.catalog.conflicts.source.opencode': '엔진',
  ...
  'settings.plugins.toast.reloadFailed': '엔진을 다시 로드하지 못했습니다. 재시작이 필요합니다',
