...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.skills.sidebar.badge.opencode': '引擎',
  ...
  'settings.skills.catalog.conflicts.source.opencode': '引擎',
  ...
  'settings.plugins.toast.reloadFailed': '引擎重新載入失敗；需要重新啟動',
  ...
  'settings.view.home.cards.plugins.description': '管理引擎外掛',
