...
export const settingsDict = {
  ...
  'settings.view.home.cards.plugins.description': 'Керуйте плагінами рушія',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.skills.sidebar.badge.opencode": "Рушій",
  ...
  "settings.skills.catalog.conflicts.source.opencode": "Рушій",
  ...
  'settings.plugins.toast.reloadFailed': 'Не вдалося перезавантажити рушій; потрібен перезапуск',
