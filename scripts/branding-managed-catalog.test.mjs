...
test('managed catalog binds eighteen exact overlaps and retains the full historical ledger', () => {
  ...
  for (const entry of catalogReloads) {
    assert.equal(entry.catalogReloadSource, '0616cc7e153a6bcef26700f197b3c3bea73744f5');
    assert.equal(entry.catalogReloadSha256, '2d6d6c5bddedd676a1b287bf55b100d5e36e5ac8873114f7ed550cef0f47bbac');
